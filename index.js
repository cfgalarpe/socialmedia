...
app.use(express.static(__dirname + '/public')); // '/client/dist/' Provide static directory for frontend
...
app.get('*', (req, res) => {
 res.sendFile(path.join(__dirname + '/public/index.html')); //'/client/index.html'
});
